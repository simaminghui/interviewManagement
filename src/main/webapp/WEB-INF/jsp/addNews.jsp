...
<form class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <input class="form-control" id="title" type="text"  placeholder="新闻题目" required="true">
        </div>
    </div>
    <div class="form-group has-success">
        ...
        <div class="col-sm-11">
            <input type="text" class="form-control" id="author" placeholder="新闻作者" required="true">
        </div>
    </div>
    <div class="form-group has-warning">
        ...
        <div class="col-sm-11">
            <input type="text" class="form-control" id="digest" placeholder="如：学术内容" required="true">
        </div>
    </div>
    ...
    <div class="form-group has-error">
        ...
        <div class="col-sm-11">
            <input type="text" class="form-control" id="introduce" required="true">
        </div>
    </div>
    <div class="row" align="center">
        <button type="button" class="btn btn-primary"
                data-toggle="button" onclick="addNews()"> 发布新闻
        </button>
    </div>
</form>
...
<script type="text/javascript">
    ...
    function addNews() {
        ...
        {
            $.post("/news/addNews",{title:title,author:author,digest:digest,content:content,introduce:introduce},function (data) {
                alert("发布成功  ");
            })
        }
